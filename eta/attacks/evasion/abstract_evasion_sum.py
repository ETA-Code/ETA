'''
Author: your name
Date: 2021-08-04 09:50:25
LastEditTime: 2021-08-04 09:50:41
LastEditors: your name
Description: In User Settings Edit
FilePath: /Cyber-Security-ML-Toolbox/eta/attacks/evasion/abstract_evasion_sum.py
'''
'''
Author: your name
...
LastEditors: your name
Description: In User Settings Edit
FilePath: /Cyber-Security-ML-Toolbox/eta/attacks/evasion/abstract_evasion.py
'''
import copy
import numpy as np
from eta.attacks.evasion.util import get_distribute

class AbstractEvasionSum:
    def __init__(self,estimator=None,norm=np.inf,eps=0.2,eps_step=0.01,upper=None,lower=None,max_iter=20):
