...
FilePath: /Cyber-Security-ML-Toolbox/eta/classifiers/model_op.py
'''
'''
Author: your name
...
class ModelOperation():
    ...
    def train(self,algorithm_name,datasets_name,model,if_adv,X_train,y_train):
        ...
        #model_path
        model_name=''
        with open(path.join('eta/classifiers/config.yaml'),'r') as config_file:
            if if_adv==True:
            ...
            model_path=path.join('eta/classifiers/saved_models',datasets_name,model_name)
