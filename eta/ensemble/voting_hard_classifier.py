...
LastEditTime: 2021-04-22 12:36:01
...
class VotingHardClassifier():
    def __init__(self,trained_models):
        self.trained_models=trained_models

    def predict(self,X_test,y_test):
        return self.hard_ensemble(X_test,y_test)

    def hard_ensemble(self,X_test,y_test):
        ...
        split_point=len(self.trained_models)/2
        # print(split_point)
        y_pred_all[y_pred_all<split_point]=0
        y_pred_all[y_pred_all>=split_point]=1
        return y_pred_all