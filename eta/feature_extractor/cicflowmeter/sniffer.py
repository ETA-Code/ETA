...
FilePath: /Cyber-Security-ML-Toolbox/eta/feature_extractor/cicflowmeter/sniffer.py
'''

from scapy.sendrecv import AsyncSniffer

from eta.feature_extractor.cicflowmeter.flow_session import generate_session_class
